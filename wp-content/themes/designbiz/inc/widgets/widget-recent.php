 ...
 */
class Designbiz_Recent_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_ops = array(
			...
			'description' => esc_html__( 'Display your site\'s most recent Posts with thumbnails.', 'designbiz' ),
			'customize_selective_refresh' => true
		);

		// Create the widget.
		parent::__construct(
			'designbiz-recent-posts',                             // $this->id_base
			esc_html__( 'Designbiz - Recent Posts', 'designbiz' ), // $this->name
	...
	public function widget( $args, $instance ) {
		...
		if ( $title ) {
			...
			$query = apply_filters( 'designbiz_widget_recent_args', $query );
	...
	public function form( $instance ) {
		$title     = isset( $instance['title'] ) ? esc_attr( $instance['title'] ) : esc_html__( 'Recent Posts', 'designbiz' );
	...
	?>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'show_date' ); ?>">
				<?php esc_html_e( 'Display post date?', 'designbiz' ); ?>
			</label>
		</p>
